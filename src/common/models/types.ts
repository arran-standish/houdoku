...
export enum GeneralSetting {
  ...
  SaveDownloadAsCBZ = 'SaveDownloadAsCBZ',
...
export enum ReaderSetting {
  ...
  KeyToggleShowingScrollbar = 'KeyToggleShowingScrollbar',
...
export const SettingTypes = {
  ...
  [GeneralSetting.SaveDownloadAsCBZ]: SettingType.BOOLEAN,
  ...
  [ReaderSetting.KeyToggleShowingScrollbar]: SettingType.STRING,
...
export const DefaultSettings = {
  ...
  [GeneralSetting.SaveDownloadAsCBZ]: false,
  ...
  [ReaderSetting.KeyToggleShowingScrollbar]: 'b',
